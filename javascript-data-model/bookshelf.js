...
console.log('Name of author is', bookshelf[1].author);
console.log('ISBN of this book is', bookshelf[0].isbn);
console.log('The title of this book is', bookshelf[2].title);
